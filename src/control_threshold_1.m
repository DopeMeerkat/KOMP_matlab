function control_threshold_1(bt, bn, section)
...
find_thresholding_values_KOMP_test_for_BioHead_2(direct, exp_name, exp_type, labels, GFP, bt, bn, section, delimeter)
